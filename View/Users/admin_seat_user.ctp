        ...
        <div class="box box-primary box-grid listing">
            <div class="box-header">
                ...
                <?php if($this->Session->read('User.User.id')==1){?>
                    <?php echo $this->Html->link('<i class="fa fa-plus"></i> '. __('Add New'), array('action' => 'suadd'), array('class' => 'btn btn-primary pull-right', 'escape' => false)); ?>
                <?php }?>
            </div>
            <div class="box-body">
                        ...
                        foreach ($users as $user):
                            ...
                            <tr> 
                                ...
                                <td>
                                    ...
                                    <?php if($this->Session->read('User.User.id')==1){?>
                                        <?php echo $this->html->link('<i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i>', array('action' => 'suedit', $user['User']['id']), array('class' => "btn btn-primary btn-xs", 'escape' => false)); ?> 
