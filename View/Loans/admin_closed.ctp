...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary filters">
            ...
            <?php echo $this->Form->create('Loans',array('type' => 'GET','url' => array('controller' => 'Loans', 'action' => 'admin_closed'))); ?>
            <div id="collapseTwo" class="panel-collapse collapse">
                <div class="panel-body">
                    <?php
                    echo $this->Html->tag('div', $this->Form->input('uid', array('value'=>$_REQUEST['uid'],'type' => 'text', 'class' => 'form-control', 'label' => __('Loan Id'))), array('class' => 'col-md-6'));
                    echo $this->Html->tag('div', $this->Form->input('loan_amount', array('value'=>$_REQUEST['loan_amount'],'type' => 'text', 'class' => 'form-control', 'label' => __('Amount'))), array('class' => 'col-md-6'));
                    echo $this->Html->tag('div', $this->Form->input('group_id', array('value'=>$_REQUEST['group_id'],'data-placeholder'=>'Select','type' => 'text', 'class' => 'form-control group', 'label' => __('Group'))), array('class' => 'col-md-6'));
