                            ...
                            <tr> 
                                ...
                                <td>
                                    ...
                                    <?php if($this->Session->read('User.User.id')==1){?>
                                        <?php echo $this->html->link('<i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i>', array('action' => 'edit', $seat['Seat']['id']), array('class' => "btn btn-primary btn-xs", 'escape' => false)); ?> 
                                        <?php echo $this->Form->postLink('<i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="Delete"></i>', array('action' => 'delete', $seat['Seat']['id']), array('confirm' => __('Do you really want to delete ' . $seat['Seat']['id'] . '?'), 'escape' => false, 'class' => "btn btn-danger btn-xs")); ?>
                                    <?php }?>
                                </td>
                            </tr> 
                            <?php
