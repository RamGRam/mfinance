        ...
        <div class="box box-primary filters">
            ...
            <div id="collapseTwo" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    echo $this->Html->tag('div', $this->Form->input('phone_no', array('type' => 'text', 'class' => 'form-control', 'label' => __('Contact'))), array('class' => 'col-md-6'));
                ...
                <table class="table table-striped table-bordered">
                    ...
                    if (empty($staffs)) {
                        ...
                        foreach ($staffs as $staff):
                            ?>
                            <tr> 
                                <td><?php echo __($staff['Staff']['id']); ?></td>
                                <td><?php echo __($staff['Staff']['name']); ?></td>
                                <td><?php echo __($staff['Staff']['phone_no']); ?></td>
                                <td><?php echo __($this->Time->format('M jS, Y h:i A', $staff['Staff']['updated'])); ?></td>
                                <td><?php echo $statuses[$staff['Staff']['is_active']]; ?></td>
                                <td>
                                    <?php echo $this->html->link('<i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i>', array('action' => 'edit', $staff['Staff']['id']), array('class' => "btn btn-primary btn-xs", 'escape' => false)); ?> 
                                    <?php echo $this->Form->postLink('<i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="Delete"></i>', array('action' => 'delete', $staff['Staff']['id']), array('confirm' => __('Do you really want to delete ' . $staff['Staff']['name'] . '?'), 'escape' => false, 'class' => "btn btn-danger btn-xs")); ?>
                                </td>
                            </tr> 
                            <?php
                        endforeach;
