        ...
        <div class="box box-primary filters">
            ...
            <div id="collapseTwo" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    echo $this->Html->tag('div', $this->Form->input('city', array('type' => 'text', 'class' => 'form-control', 'label' => __('City'))), array('class' => 'col-md-6'));
                    echo $this->Html->tag('div', $this->Form->input('uid', array('type' => 'text', 'class' => 'form-control', 'label' => __('Center Id'))), array('class' => 'col-md-6'));
            ...
            <div class="box-body">
                <table class="table table-striped table-bordered">
                    <tr class="actions">
                        ...
                        <th><?php echo __('Disbursement Date'); ?></th>
                    ...
                    if (empty($centers)) {
                        ...
                        foreach ($centers as $center):
                            ?>
                            <tr> 
                                <td><?php echo __($center['Center']['name']); ?></td>
                                <td><?php echo __($center['Center']['city']); ?></td>
                                <td><?php echo __($center['Center']['uid']); ?></td>
                                <td><?php echo __($this->Time->format('M jS, Y', $center['Center']['disbursement_date'])); ?></td>
                                <td><?php echo __($this->Time->format('M jS, Y h:i A', $center['Center']['updated'])); ?></td>
                                <td><?php echo $statuses[$center['Center']['is_active']]; ?></td>
                                <td>
                                    <?php echo $this->html->link('<i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i>', array('action' => 'edit', $center['Center']['id']), array('class' => "btn btn-primary btn-xs", 'escape' => false)); ?> 
                                    <?php echo $this->Form->postLink('<i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="Delete"></i>', array('action' => 'delete', $center['Center']['id']), array('confirm' => __('Do you really want to delete ' . $center['Center']['name'] . '?'), 'escape' => false, 'class' => "btn btn-danger btn-xs")); ?>
                                </td>
                            </tr> 
                            <?php
                        endforeach;
