    ...
    <div class="box-body">
        <?php
	        ...
	        echo $this->Form->input('id');
                ...
                echo $this->Form->input('city', array('type' => 'text', 'label' => __('City')));
                echo $this->Form->input('uid', array('type' => 'text', 'label' => __('Center Id')));    
                echo $this->Form->input('disbursement_date', array('type' => 'date', 'label' => __('Disbursement Date')));
