...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary filters">
            ...
            <?php echo $this->Form->create('Groups',array('type' => 'GET','url' => array('controller' => 'Groups', 'action' => 'admin_closed'))); ?>
            <div id="collapseTwo" class="panel-collapse collapse">
                <div class="panel-body">
                    <?php
                        echo $this->Html->tag('div', $this->Form->input('name', array('value'=>$_REQUEST['name'],'type' => 'text', 'class' => 'form-control', 'label' => __('Name'))), array('class' => 'col-md-6'));
                        echo $this->Html->tag('div', $this->Form->input('center_id', array('value'=>$_REQUEST['center_id'],'data-placeholder'=>'Select','type' => 'text', 'class' => 'form-control center', 'label' => __('Center'))), array('class' => 'col-md-6'));
                    ?> 
                </div>
