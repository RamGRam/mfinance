<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary filters">
            ...
            <?php echo $this->Form->create('SeatDues',array('type' => 'GET','url' => array('controller' => 'SeatDues', 'action' => 'admin_closed'))); ?>
            <div id="collapseTwo" class="panel-collapse collapse">
                <div class="panel-body">
                    <?php
                        echo $this->Html->tag('div', $this->Form->input('seat_id', array('value'=>$_REQUEST['seat_id'],'data-placeholder'=>'Select','type' => 'text', 'class' => 'form-control closed_seat', 'label' => __('Seat Id'))), array('class' => 'col-md-6'));
                        echo $this->Html->tag('div', $this->Form->input('user_id', array('value'=>$_REQUEST['user_id'],'data-placeholder'=>'Select','type' => 'text', 'class' => 'form-control seatcustomer', 'label' => __('Customer'))), array('class' => 'col-md-6'));
